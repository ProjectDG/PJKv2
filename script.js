...
class Drink{
   ...
   */
   ...
   let zenInferno = new Drink("Zen Inferno", "Rocks Glass", "Tajin", ["Casamigos Reposado - 1.5 oz"], ["Cointreau - .75 oz"], ["Chili Tincture - 2 ea.,", "Lime Juice - .5 oz,", "Mango Puree - 1 oz,", "Pineapple Juice - .75 oz"], ["Pineapple Frond & Mango Slice", "May Be Changing"], null, null, ["Instructions", "--------------------------------", "Shake", "&", "Strain"])
   let lotusBlossom = new Drink("Lotus Blossom", "Martini Glass", null, ["Gin or Vodka - 1.5 oz"], ["Sake - 1.5 oz,", "Lillet Blanc - .25 oz"], null, ["Plum Wine Foam &", "Dehydrated Plum"], null, null, ["--------------------------------", "Instructions", "--------------------------------", "- Add to Mixing Glass", "- Stir and Strain", "--------------------------------", "Foam Batch", "--------------------------------", "Plum Wine - 6 oz", "Agave - 5 oz", "Lemon Juice - 3 oz"])
   let crouchingTiger = new Drink("Crouching Tiger", "Pint Glass", null, null, null, ["Lime - 1 oz,", "Matcha Syrup - 1 oz,", "Pineapple - .25 oz,", "Shiso Leaf", "Soda ( Topped )"], ["Flower"], null, null, null);
   ...
   let pjKiller = new Drink("PJ Killer", "Collins Glass", null, ["Coconut Rum - 1.5 oz"], ["Luxardo Cherry Liqueur - .5 oz", "Drambuie - .25 oz", "Lillet Blanc - .25 oz"], ["Lime Juice - .75 oz", "Demerara Syrup - .5 oz", "Pineapple Juice - .5 oz"], ["Cinnamon Stick & Shavings,", "Dehydrated Lime"],null, null, ["Instructions", "--------------------------------", "Shake", "&", "Strain"]);
